...
public class ConnectionCreator {
    ...
    static void reset() {
        ...
        try (Connection connection = DriverManager.getConnection(CN.URL_DB, CN.USER_DB, CN.PASSWORD_DB))
        {
            ...
            statement.executeUpdate("INSERT INTO `malishevskiy`.`users` (`ID`, `Login`, `Password`, `Email`, `roles_ID`)" +
                    "VALUES (DEFAULT, 'admin', 'padmin', 'admin@it.by', 1);\n");
            statement.executeUpdate("INSERT INTO `malishevskiy`.`users` (`ID`, `Login`, `Password`, `Email`, `roles_ID`)" +
                    "VALUES (DEFAULT, 'user', 'puser', 'user@it.by', 2);\n");
            statement.executeUpdate("INSERT INTO `malishevskiy`.`ads` (`ID`, `Animal`, `Weight (kg)`, `Color`, `Price ($)`, `Description`, `Adress`, `users_ID`)" +
                    "VALUES (DEFAULT, 'Dog', '7', 'Black', 100, 'Добрая собака трех лет от роду ищет не менее добрую семью. Привитая, обожает играть со своим мячиком, кошками, и детьми)', 'ул. Западная 9-90', 2);\n");
            statement.executeUpdate("INSERT INTO `malishevskiy`.`ads` (`ID`, `Animal`, `Weight (kg)`, `Color`, `Price ($)`, `Description`, `Adress`, `users_ID`)" +
                    "VALUES (DEFAULT, 'Cat', '3', 'White', 75, 'Новорожденная русская голубая кошка. Документы - в наличии, как и очень добрый, ласковый характер. Когтедралка - в подарок.', 'ул. Сухаревская 12-74', 2);\n");
            statement.executeUpdate("INSERT INTO `malishevskiy`.`ads` (`ID`, `Animal`, `Weight (kg)`, `Color`, `Price ($)`, `Description`, `Adress`, `users_ID`)" +
                    "VALUES (DEFAULT, 'Parrot', '2', 'Red-White-Blue', 200, 'Годовалый (год от роду) разговаривающий попугай прямиком из Турции. Может запомнить до 500 слов, детишек особо радует. За лишние 30$ отдаем корм на месяц + стойку с клеткой', 'ул. Индустриальная 5-5', 2);\n");
